...
import '../IBurnByOwner.sol';

contract Data is IData, IndexResolver, IBurnByOwner, RequiredInterfaces {
    address _addrRoot;
    address _addrOwner;
    ...
    constructor(
        ...
        _requiredInterfaces = [RequiredInterfacesLib.ID, BurnByOwnerLib.ID];
    ...
    function burnByOwner() external override onlyOwner {
