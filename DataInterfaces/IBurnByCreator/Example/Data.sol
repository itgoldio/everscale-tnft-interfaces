...
import '../IBurnByCreator.sol';

contract Data is IData, IndexResolver, IBurnByCreator, RequiredInterfaces {
    address _addrRoot;
    address _addrOwner;
    ...
    constructor(
        ...
        _requiredInterfaces = [RequiredInterfacesLib.ID, BurnByCreatorLib.ID];
    ...
    function burnByCreator() external override onlyRoot {
