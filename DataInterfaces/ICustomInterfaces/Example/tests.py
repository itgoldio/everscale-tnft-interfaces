...
#68747470733a2f2f6769746875622e636f6d2f6578616d706c65 (in hex) = https://github.com/example
customInterfacesUrl = "68747470733a2f2f6769746875622e636f6d2f6578616d706c65"
payload = ts4.encode_message_body('compiled/NftRoot', 'mintNft', {'customInterfacesUrl': customInterfacesUrl})
...
answUrl = data.call_getter('getCustomInterfacesUrl')
answReqInterfaces = data.call_getter('getRequiredInterfaces')

assert eq(answUrl, bytes.fromhex(customInterfacesUrl).decode('utf-8'))
