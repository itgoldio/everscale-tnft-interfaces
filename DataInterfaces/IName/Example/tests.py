...
#53616d706c65204e4654 (in hex) = Sample NFT
dataName = "53616d706c65204e4654"
payload = ts4.encode_message_body('compiled/NftRoot', 'mintNft', {'dataName': dataName})
...
IName = 2
ReqInterfaces = [IRequiredInterfaces, IName]

answer = data.call_getter('getName')
answReqInterfaces = data.call_getter('getRequiredInterfaces')

assert eq(answer, bytes.fromhex(dataName).decode('utf-8'))
