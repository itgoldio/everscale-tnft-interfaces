...
import '../IStoreOnChain.sol';
import '../../IRequiredInterfaces/IRequiredInterfaces.sol';

contract NftRoot is DataResolver, IndexResolver, RequiredInterfaces, StoreOnChain {
    ...
    constructor(
        ...
        _iconAddr = iconAddr;
        _requiredInterfaces = [RequiredInterfacesLib.ID, StoreOnChainLib.ID];
    }
