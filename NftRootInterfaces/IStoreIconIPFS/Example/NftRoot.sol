...
import '../IStoreIconIPFS.sol';
import '../../IRequiredInterfaces/IRequiredInterfaces.sol';

contract NftRoot is DataResolver, IndexResolver, RequiredInterfaces, StoreIconIPFS {
    ...
    constructor(
        ...
        _iconUrl = iconUrl;
        _requiredInterfaces = [RequiredInterfacesLib.ID, StoreIconIPFSLib.ID];
    }
