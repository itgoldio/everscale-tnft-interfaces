...
import '../../../vendoring/resolvers/DataResolver.sol';
...
import '../ICustomInterfaces.sol';
import '../../IRequiredInterfaces/IRequiredInterfaces.sol';

contract NftRoot is DataResolver, IndexResolver, RequiredInterfaces, CustomInterfaces {
    ...
    constructor(
        ...
        _customInterfacesUrl = customInterfacesUrl;
        _requiredInterfaces = [RequiredInterfacesLib.ID, CustomInterfacesLib.ID];
    }
